...
const NAV_KEYS = [
  { href: ROUTES.DASHBOARD, key: 'nav.dashboard', label: 'Dashboard', icon: DashboardIcon },
  { href: ROUTES.USERS, key: 'nav.users', label: 'Users', icon: UsersIcon },
  { href: ROUTES.ANALYTICS, key: 'nav.analytics', label: 'Analytics', icon: AnalyticsIcon },
  { href: ROUTES.API_USAGE, key: 'nav.api_usage', label: 'API Usage', icon: ChartIcon },
  ...
  { href: ROUTES.DOCS, key: 'nav.docs', label: 'Documentation', icon: DocsIcon },
] as const;

export default function Sidebar({ isOpen, onClose, labels }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-72 glass border-r border-purple-100 transform transition-all duration-300 lg:translate-x-0 lg:static lg:z-auto ${
      ...
      >
        <div className="flex items-center justify-between h-20 px-6 border-b border-purple-100">
          ...
          <button onClick={onClose} className="lg:hidden p-2 text-gray-400 hover:text-gray-600 rounded-lg">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                  isActive
                    ? 'bg-gradient-to-r from-[#6D28D9] to-[#8B5CF6] text-white shadow-lg shadow-purple-500/30'
